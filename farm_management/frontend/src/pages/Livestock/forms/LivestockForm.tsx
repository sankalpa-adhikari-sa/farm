...
import {useAddLivestockData, useLivestock, useUpdateLivestockByID } from '@/pages/Livestock/hooks/useLivestockData';
...
const { id } = useParams();
const current_livestock:any=  dam_id_Query.data?dam_id_Query.data.find(item => (item.id === id )):[]
